...
FishBot.TxtRoll = MkInp(FishBot.Frm, 10, "Delay Roll (s):", "2.3", function(b) FishBot.DelayRoll = tonumber(b.Text) or 2.3; b.Text=tostring(FishBot.DelayRoll) end)
FishBot.TxtCatch = MkInp(FishBot.Frm, 50, "Delay Catch (s):", "2.3", function(b) FishBot.DelayCatch = tonumber(b.Text) or 2.3; b.Text=tostring(FishBot.DelayCatch) end)
C("TextLabel", {Parent=FishBot.Frm, Size=U2(0,120,0,25), Position=U2(0,20,0,90), BackgroundTransparency=1, Text="Equipped Rod:", TextColor3=C3(80,80,80), Font=F_G, TextSize=13, TextXAlignment=0})
FishBot.LblRod = C("TextLabel", {Parent=FishBot.Frm, Size=U2(0,150,0,25), Position=U2(1,-170,0,90), BackgroundColor3=C3(235,235,235), Text="Detecting...", TextColor3=C3(100,100,100), Font=F_GM, TextSize=12, C("UICorner",{CornerRadius=UDim.new(0,6)}), C("UIStroke",{Color=C3(210,210,210)})})
FishBot.Btn = C("TextButton", {Parent=FishBot.Frm, Size=U2(0,320,0,40), Position=U2(0.5,-160,0,135), BackgroundColor3=C3(180,180,180), Text="Lock: Equip Rod", TextColor3=C3(255,255,255), Font=F_GM, TextSize=14, AutoButtonColor=false, C("UICorner",{CornerRadius=UDim.new(0,8)}), Click=function() FishBot:Start() end})
